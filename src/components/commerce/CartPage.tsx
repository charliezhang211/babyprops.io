...
export default function CartPage() {
  ...
  const handleCheckout = () => {
    ...
    // Redirect immediately - validation happens on checkout page
        ...
        <div className="lg:w-80 flex-shrink-0">
          <div className="sticky top-8 p-6 bg-brand-light border border-gray-200 rounded-2xl space-y-5">
            ...
            <button
              ...
              className="w-full py-3.5 bg-brand hover:bg-brand-dark text-white font-semibold rounded-full transition-all duration-300 active:scale-[0.98] shadow-md hover:shadow-lg"
            >
              {L.checkoutButton}
            </button>
